...
export const House = (props) => {
  ...
  useLayoutEffect(()=> {
    ...
    mm.current.add(
      "(min-width: 1500px)",() => {
        ...
        tl.to(camera.current.position,{x:0,y:10,z:13, duration:0.01});
        ...
        tl.fromTo(floor1.current.scale, {x:0,y:0,z:0.05},{x:80,y:80,z:0.05,duration:3});
        tl.fromTo(camera.current.position,{x:0,y:10,z:13}, {x:-7,duration:5},"<");
        tl.fromTo(".about-me",{borderTopRightRadius:1000}, {duration:3, borderTopRightRadius:0});
        ...
        tl.fromTo(floor2.current.scale, {x:0,y:0,z:0.05},{x:50,y:50,z:0.05,duration:3});
        tl.fromTo(camera.current.position,{x:-7},{x:3.5,y:4.5,z:3,duration:5},"<");
        tl.fromTo(".my-work",{borderTopLeftRadius:1000}, {duration:5, borderTopLeftRadius:0});
        ...
        tl.fromTo(floor3.current.scale, {x:0,y:0,z:0.05},{x:35,y:35,z:0.05,duration:3});
        tl.fromTo(camera.current.position,{x:3.5,y:4.5,z:3},{x:-2.5,y:3,z:7,duration:5},"<");
  ...
  //======================TIMELINE "(min-width: 1250px) and (max-width:1499px)" ============================
    mm.current.add(
      "(min-width: 1250px) and (max-width:1499px)",() => {
        ...
        tl.fromTo(floor1.current.scale, {x:0,y:0,z:0.05},{x:80,y:80,z:0.05,duration:3});
        tl.fromTo(camera.current.position,{x:0,y:10,z:13}, {x:-5.5,duration:5},"<");
        tl.fromTo(".about-me",{borderTopRightRadius:1000}, {duration:3, borderTopRightRadius:0});
        //progress bar for about-me section
        tl = gsap.timeline({
          scrollTrigger:{
        ...
        tl.fromTo(floor2.current.scale, {x:0,y:0,z:0.05},{x:80,y:80,z:0.05,duration:3});
  ...
  //======================TIMELINE "(min-width: 969px) and (max-width:1249px)" ============================
    mm.current.add(
      ...
      tl.fromTo(floor1.current.scale, {x:0,y:0,z:0.05},{x:80,y:80,z:0.05,duration:3});
      tl.fromTo(camera.current.position,{x:0,y:10,z:13} ,{x:-4.5,duration:5},"<");
      tl.fromTo(".about-me",{borderTopRightRadius:1000}, {duration:3, borderTopRightRadius:0});
      //progress bar for about-me section
      tl = gsap.timeline({
        scrollTrigger:{
      ...
      tl.fromTo(floor3.current.scale, {x:0,y:0,z:0.05},{x:25,y:25,z:0.05,duration:3});
      tl.fromTo(camera.current.position, {x:3.5,y:5.5,z:5,duration:5},{x:-2,y:3,z:8,duration:5},"<");
      tl.fromTo(".contact-me",{borderTopRightRadius:1000}, {duration:3, borderTopRightRadius:0});
      //progress bar for contact-me section
      tl = gsap.timeline({
        scrollTrigger:{
    ...
    <>
      ...
      <group rotation={[0,-0.7,0]} {...props} dispose={null}>
        ...
        <group ref={scale7}>
          ...
          <mesh castShadow geometry={nodes.blender.geometry} material={materials['AGILE.001']} position={[1.234, 2.994, -2.26]} rotation={[Math.PI / 2, 0, -0.495]} scale={0.627} />
          <mesh castShadow geometry={nodes['cube-blender'].geometry} material={materials['cube-agile.001']} position={[1.226, 2.992, -2.377]} rotation={[0, -1.076, 0]} />
          <mesh castShadow geometry={nodes.threejs.geometry} material={materials.threejs} position={[0.815, 3.21, -2.278]} rotation={[Math.PI / 2, 0, -0.664]} scale={0.652} />
          <mesh castShadow geometry={nodes['cube-threejs'].geometry} material={materials['cube-threejs']} position={[0.796, 3.247, -2.397]} rotation={[0, 0.664, 0]} />
          <mesh castShadow geometry={nodes.Circle.geometry} material={materials['default']} position={[0.876, 3.299, -2.303]} rotation={[1.387, -0.229, -0.685]} scale={0.317} />
          <mesh castShadow geometry={nodes.Circle001.geometry} material={materials['three-js-triangle']} position={[0.9, 3.307, -2.322]} rotation={[0.364, -0.874, -1.287]} scale={0.317} />
          <mesh castShadow geometry={nodes.Circle002.geometry} material={materials['three-js-triangle']} position={[0.859, 3.323, -2.29]} rotation={[0.364, -0.874, -1.287]} scale={0.317} />
          <mesh castShadow geometry={nodes.Circle003.geometry} material={materials['three-js-triangle']} position={[0.868, 3.268, -2.297]} rotation={[2.095, 0.57, -0.821]} scale={0.317} />
